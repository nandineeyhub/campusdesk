       ...
       <NavLink  className=" text-decoration-none d-flex align-items-center pb-3 mb-md-0 me-md-auto text-secondary text-decoration-none">
        ...
        <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <li className="nav-item">
               <NavLink to="/desk/client" className="my-2 text-decoration-none align-middle px-0 d-flex text-secondary">
                    <i className="fa fa-address-card-o"></i> <span className=" mx-2  "><h6>Client List</h6></span>
                </NavLink>
            </li>
            <li >
               <NavLink to="/desk/client/addclient"   className="my-2 text-secondary text-decoration-none px-0 align-middle d-flex">
                    <i className="fa fa-key"></i> <span className="mx-2 "><h6>Add Client</h6></span> </NavLink>
