      ...
      <div className="container-lg">
       ...
       {/* <button  className=" btn btn-muted navbar-toggler-icon "></button> */} 
          ...
          <ul className='d-md-flex d-lg-flex list-unstyled'>
           ...
           <NavLink className="text-decoration-none">  <li className='mx-3 mt-3 text-secondary'> Clients </li></NavLink>
           <NavLink className="text-decoration-none">  <li className='mx-3 mt-3 text-secondary'> Users </li></NavLink>
